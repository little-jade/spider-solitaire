...
class Card {
  ...
  moveTo(pos) {
    ...
    let xtime = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.2;
    let ytime = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.2;
...
class Container {
  ...
  get nextPosition() {
    ...
    return this.type == "tomb" ? this.position : this.position.plus(new Vec(20 * groupN, 0));
  }
...
class WorkCol extends Container {
  ...
  get nextPosition() {
    ...
    let yadd = (_this$lastCard = this.lastCard) !== null && _this$lastCard !== void 0 && _this$lastCard.isView ? 24 : 12;
